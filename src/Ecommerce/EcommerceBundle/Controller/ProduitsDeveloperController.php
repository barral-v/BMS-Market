 ...
 *
 */
class ProduitsDeveloperController extends Controller
{
    ...
    public function createAction(Request $request)
    {
        ...
        if ($form->isValid()) {
            ...
            return $this->redirect($this->generateUrl('developerProduits_show', array('id' => $entity->getId())));
        }

        return $this->render('EcommerceBundle:Developer:Produits/layout/new.html.twig', array(
            'entity' => $entity,
    ...
    */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('EcommerceBundle:Produits')->findOneBy(array('id'          => $id,
        ...
        return $this->render('EcommerceBundle:Developer:Produits/layout/show.html.twig', array(
            'entity'      => $entity,
    ...
    public function editAction($id)
    {
        ...
        return $this->render('EcommerceBundle:Developer:Produits/layout/edit.html.twig', array(
            'entity'      => $entity,
    ...
    */
    ...
    public function updateAction(Request $request, $id)
    {
        ...
        if ($editForm->isValid()) {
            ...
            return $this->redirect($this->generateUrl('developerProduits_edit', array('id' => $id)));
        }
    ...
    public function deleteAction(Request $request, $id)
    {
        ...
        return $this->redirect($this->generateUrl('developerProduits'));
    }
    ...
    private function createDeleteForm($id)
    {
        return $this->createFormBuilder()
            ->setAction($this->generateUrl('developerProduits_delete', array('id' => $id)))
            ->setMethod('DELETE')
