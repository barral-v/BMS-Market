...
class Produits
{
    ...
    /**
     * @ORM\ManyToOne(targetEntity="Utilisateurs\UtilisateursBundle\Entity\Utilisateurs", cascade={"persist"})
    ...
    /**
     * @ORM\OneToOne(targetEntity="Ecommerce\EcommerceBundle\Entity\Module", cascade={"persist","remove"})
     * @ORM\JoinColumn(nullable=false)
     */
    private $module;
   ...
   /**
     * Set module
     *
     * @param \Ecommerce\EcommerceBundle\Entity\Module $module
     * @return Produits
     */
    public function setModule(\Ecommerce\EcommerceBundle\Entity\Module $module)
    {
        $this->module = $module;
     ...
     * Get module
     *
     * @return \Ecommerce\EcommerceBundle\Entity\Module
     */
